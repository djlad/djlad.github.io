...
// src/engine/component/components/position/position-component.ts
...
// src/engine/component/components/animation/animation-component.ts
...
// src/components/animation-component.ts
var AnimationComponent2 = class extends Component {
  constructor(animationName, delay, spriteManager) {
    super("animation");
    this.delay = delay;
    this.currentDelay = delay;
  ...
  static create() {
    var spriteManager = SpriteManager.singeltonCreate();
    var ac = new AnimationComponent2("blond", 2, spriteManager);
    return ac;
  }
};
...
// src/components/inventory-component/give-item-event-data.ts
var GiveItemEventData = class {
...
// src/components/lines-component.ts
var LinesComponent = class extends Component {
  constructor() {
    super("lines");
  }
  targetIds;
...
// src/engine/component/components/effect/effect-component.ts
var EffectComponent = class extends Component {
  targets = [];
...
// src/engine/phaser-integration/phaser-components/phaser-animation-component.ts
var PhaserAnimationComponent = class extends Component {
  animationName;
  spriteName;
  animationNameUpdated = false;
  phaserGame;
...
// src/engine/phaser-integration/phaser-components/phaser-position-component.ts
...
// src/engine/phaser-integration/phaser-cameras.ts
var PhaserCameras = class {
  phaserGame;
  constructor(phaserGame) {
    this.phaserGame = phaserGame;
  }
  center;
  setMainCamera(position) {
...
// src/engine/phaser-integration/phaser-game-dependencies.ts
var PhaserGameDependencies = class extends GameDependencies {
  phaserGame = null;
};

// src/engine/phaser-integration/phaser-dependency-builder.ts
...
// src/engine/phaser-integration/phaser-systems/phaser-render-system.ts
...
// src/engine/phaser-integration/phaser-builder.ts
...
function createPhaserGame(game = null) {
  if (game == null) {
...
// src/entities/lines-entity.ts
var LinesEntity = class {
  create(gameDependencies, entity) {
    var position = entity.addComponent("position");
    return entity;
  }
...
var MapBuilderSystem = class extends EntitySystem {
  ...
  openBuilder = false;
  tilePallete = [];
  selectedSpriteId = SpriteId.create("soil", 0);
  constructor(game) {
    super(game);
    this.game.eventManager.addListener(28 /* mouseUp */, (data) => {
      if (!this.openBuilder)
...
var RenderSystem = class extends EntitySystem {
  camera;
  /**
   * used for drawing animation components
   */
...
function buildComponents2(game) {
...
function createPhaserGameGeneric() {
...
function createGame(game = null) {
  ...
  buildSprites(game);
  buildEntities(game);
  buildComponents2(game);
  return game;
}

// src/systems/fight-system.ts
var FightSystem = class extends EntitySystem {
  constructor(game) {
    super(game);
  }
...
export {
  ...
  PhaserCameras,
  PhaserGame,
  PhaserGameDependencies,
  PhaserPositionComponent,
  PhaserRenderSystem,
  PhaserSpriteManager,
  PixiDependencies,
  PixiGame,
  ...
  buildDependencies,
  buildEntities,
  buildPhaserDependencies,
  buildSprites,
  createGame,
  createPhaserGame,
  createPhaserGameGeneric,
  createPixiGame,
  keyEvents,
  metadata,
  pixiGameBuilder,
  populateSpriteManager
};
