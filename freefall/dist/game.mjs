...
${item.itemName}: ${item.itemQuantity}`;
  ...
  function addGyroPermissionButton(handleOrientation) {
  ...
  function onGyroClick(handleOrientation) {
    return () => {
      if (typeof DeviceOrientationEvent.requestPermission === "function") {
  ...
  var FloorChallenge = /* @__PURE__ */ ((FloorChallenge2) => {
    ...
    FloorChallenge2[FloorChallenge2["custom"] = 3] = "custom";
  ...
  var FloorSystem = class _FloorSystem extends EntitySystem {
    ...
    oncePerLoop = (args) => {
      ...
      if (newChallenge === 2 /* challengeDone */) {
        ...
        while (this.currentChallenge === 2 /* challengeDone */) {
          this.currentChallenge = randomEnum(FloorChallenge);
        }
